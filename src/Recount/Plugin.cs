...
namespace Recount
{
    ...
    public sealed class RecountPlugin : BaseUnityPlugin
    {
        public const string PluginGuid = "com.jumpingmushroom.recount";
        public const string PluginName = "Recount";
        ...
        private void Awake()
        {
            ...
            _harmony.PatchAll(typeof(RecountPlugin).Assembly);
